...
- Alternative sources like FactSet or Nasdaq Data Link
...
- Academic work usually uses Compustat (Capital I.Q.)
  - Data goes back to 1960s
  - Usually don't get daily updates
...
import quandl
quandl.ApiConfig.api_key = # must be filled in
...
- Monthly returns
- 100+ stock characteristics calculated at the beginning of each month
