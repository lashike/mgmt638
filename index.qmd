...
This course provides an introduction to quantitative equity management.  Quantitative management means trading on signals that can be constructed and tested on large panels of stocks.  Many different data sources are used to generate trading signals.  In this course, we will illustrate concepts using price signals and corporate fundamentals.  Some additional data sources will be analyzed in *Data Driven Investments Lab* (see below).  We will discuss the full process of quantitative management, from preliminary analysis of signals to training models to backtesting and strategy assessment.  
...
1. A look at some data providers: Nasdaq Data Link and Yahoo Finance
...
6. Industries: to trade or not to trade?
