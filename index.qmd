## MGMT 638<br>Data-Driven Investments: Equity<br>Rice University JGSB<br>Fall 2023
...
The group project will be to analyze a specific data set of signals and returns and to test a quantitative investment strategy using the methods developed in the course.  It will require putting things together, but it will not require significant new code development.  The project is due on December 11.  Groups **must** consist of three or fewer students.
