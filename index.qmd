...
ChatGPT makes it much easier to use python. Throughout the course, we will generate python code by using ChatGPT either at the OpenAI website or via an extension to VS Code.  One skill you should develop in the course is to become a good "prompt engineer."
