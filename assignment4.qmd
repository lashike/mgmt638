...
Submit a Jupyter notebook.  Copy each question into a Markdown cell and provide your answer in the cell or cells below it.
  ...
  4.  Use TransformedTargetRegressor, OneHotEncoder, and make_column_transformer to create a pipeline as in notebook/slides "9-targets-and-industries"
